...
@pytest.mark.asyncio
async def test_get_storages(client: TestClient, mock_storage_gateway: AsyncMock) -> None:
...
@pytest.mark.asyncio
async def test_get_storages_empty(client: TestClient, mock_storage_gateway: AsyncMock) -> None:
    mock_storage_gateway.get_storages.return_value = []
